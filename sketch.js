...
gover = loadImage("IMAGENES/gameOver.png");
youwin=loadImage("IMAGENES/ganaste.png")
...
//NAVES SE MUEVEN
  ...
  if(nave.isTouching(nova)){
    gameState=END;
      over = createSprite(800,300,20,20);
  ...
  if(GemCount===5){
    gameState=END;
    win=createSprite(800,300,20,20)
    win.addImage("winner",youwin)
    win.scale=0.7
    nave4.velocityX=0
    nave3.velocityX=0
    nave2.velocityX=0
